...
import { preciousMetalImages } from './constants/preciousMetalImages';
import { defaultCatalogProducts } from './constants/defaultProducts';

// Fallback precious metals investment products (used when Supabase catalog is empty)
const fallbackCatalogMachines: Machine[] = defaultCatalogProducts;
...
export default function App() {
  ...
  const [catalogMachines, setCatalogMachines] = useState<Machine[]>(defaultCatalogProducts);
